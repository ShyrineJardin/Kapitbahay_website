        ...
        <div className='container flex justify-center items-center py-10'>
            ...
            className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 space-x-5 space-y-5'>
              ...
              <div className='flex flex-col items-center text-center'>
                <img src={Errand} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
               <div className='flex flex-col items-center text-center'>
                <img src={House} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
               <div className='flex flex-col items-center text-center'>
                <img src={Study} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
              <div className='flex flex-col items-center text-center'>
                <img src={Moving} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
               <div className='flex flex-col items-center text-center'>
                <img src={Elders} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
               <div className='flex flex-col items-center text-center'>
                <img src={Event} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
               <div className='flex flex-col items-center text-center'>
                <img src={Shopping} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
               ...
               {/* services */}
               <div className='flex flex-col items-center text-center'>
                <img src={Custom} alt="" className='bg-main p-5 rounded-full h-40 w-40 mb-2 shadow-lg hover:scale-105 duration-300'/>
